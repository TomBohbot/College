...
public class DocumentStoreImplTest  {
    ...
    //     testList.add(inputStreamContent4);
    //     testList.add(inputStreamContent5);
    //     assertEquals("Testing search for texts" , testList , doc.searchByPrefix("s") );
    //     ArrayList <String> testListTwo = new ArrayList <String> ();
    //     testList.add(inputStreamContent1);
    //     testList.add(inputStreamContent4);
    //     testList.add(inputStreamContent5);        
    //     assertEquals("Testing search for texts" , testListTwo , doc.searchByPrefix("sh") );
    //     testList.add(inputStreamContent5);        
    //     assertEquals("Testing search for texts" , testListTwo , doc.searchByPrefix("shu") );
    ...
    @Test
    public void TestTrieUndoPutDocAsTextUndoGeneral() {
