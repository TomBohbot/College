...
public class IntegerLRUCacheTest {
	...
	public void notInteger () {
        IntegerLRUCache cache = new IntegerLRUCache(5);
        assertEquals(null , cache.remove('a') );
    }
    ...
    public void testRemove() {
        ...
        Integer putFour = cache.put(4 , 40);
        Integer putFive = cache.put(5 , 50);
        assertEquals((Integer) 10 , cache.remove( (Integer) 1) );
        assertEquals((Integer) 20 , cache.remove( (Integer) 2) );
        assertEquals((Integer) 30 , cache.remove( (Integer) 3) );
        assertEquals((Integer) 40 , cache.remove( (Integer) 4) );
        assertEquals((Integer) 50 , cache.remove( (Integer) 5) );
        assertEquals((Integer) null , cache.remove( (Integer) 3) );
        Integer putOneTwo = cache.put(1 , 100);
        Integer putTwoTwo = cache.put(2 , 200);
        Integer putThreeTwo = cache.put(3 , 300);
        Integer putFourTwo = cache.put(4 , 400);
        Integer putFiveTwo = cache.put(5 , 500);
        assertEquals((Integer) 100 , cache.get(1));
        assertEquals((Integer) 200 , cache.get(2));
        assertEquals((Integer) 300 , cache.get(3));
        assertEquals((Integer) 400 , cache.get(4));
        assertEquals((Integer) 500 , cache.get(5));
    }
    ...
    public void testEquals() {
        IntegerLRUCache cache = new IntegerLRUCache(5);
        IntegerLRUCache cacheTwo = new IntegerLRUCache(5);
        cache.put(1 , 10);
        cache.put(2 , 20);
        cache.put(3 , 30);
        cache.put(4 , 40);
        ...
        cacheTwo.put(4 , 40);
        cacheTwo.put(5 , 50);
        assertTrue(cache.equals(cacheTwo) );
        cacheTwo.put(6 , 60);
        cacheTwo.get(4);
        cacheTwo.put(7 , 70);
        cacheTwo.put(8 , 80);
        cacheTwo.put(9 , 90);
        assertFalse(cache.equals(cacheTwo) );
        cache.put(6 , 60);
        cache.put(7 , 70);
        cache.put(8 , 80);
        cache.put(9 , 90);
